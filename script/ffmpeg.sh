...
download_ffmpeg_linux() {
  local url="https://github.com/eugeneware/ffmpeg-static/releases/download/b4.4.1/linux-$arch"
...
#    mkdir -p "$output"
#  fi
#  tar -xf "${download_dir}/ffmpeg.tar.xz" --wildcards --strip-components 1 -C "$output" '*/ffmpeg'
